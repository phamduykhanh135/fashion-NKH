...
class _QuanLySPState extends State<QuanLySP> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Quản lý sản phẩm",style: TextStyle(color: MyColor.dark_pink,fontWeight: FontWeight.bold)),
        centerTitle: true,
        backgroundColor: MyColor.light_pink,
        actions: [
          IconButton(onPressed: (){}, icon: Icon(Icons.search,color:MyColor.dark_pink,)),
          IconButton(onPressed: (){}, icon: Icon(Icons.add,color:MyColor.dark_pink)),
        ],
